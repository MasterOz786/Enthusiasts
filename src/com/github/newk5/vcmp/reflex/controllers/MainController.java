package com.github.newk5.vcmp.reflex.controllers;

import com.github.newk5.vcmp.reflex.commands.AdminCommands;
import com.github.newk5.vcmp.reflex.commands.PlayerCommands;
...
public class MainController extends RootEventHandler {
    ...
    public void onServerLoadScripts() {
        System.out.println("Re-Flex started!");
    }

    public void onPlayerWeaponChange(Player p, int oldWep, int newWep) {
        server.sendClientMessage(p, COLOUR_YELLOWISH, String.format("You have changed the weapon [ID: %d -> ID %d]", oldWep, newWep));
    }
